...
our %config = (
    ...
    "perlargv" => [
        ...
        "no-shared",
        "no-threads",
        "--prefix=E:\\nginx-1.25.0\\objs\\openssl-3.0.9/openssl",
        "--openssldir=E:\\nginx-1.25.0\\objs\\openssl-3.0.9/openssl/ssl",
        "no-asm",
        "no-tests",
...
unless (caller) {
    ...
    use lib 'E:/nginx-1.25.0/objs/openssl-3.0.9/util/perl';
    use OpenSSL::fallback 'E:/nginx-1.25.0/objs/openssl-3.0.9/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib 'E:/nginx-1.25.0/objs/openssl-3.0.9/Configurations';
        use gentemplate;
